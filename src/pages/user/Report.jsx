  ...
  return (
    <div className="p-2 xs:p-3 sm:p-6 lg:p-8">
      ...
      <div className="mb-6">
        ...
        {/* Alert Messages */}
        {success && (
          <div className="mb-6 bg-green-900/30 border border-green-500/50 text-green-100 px-4 py-3 rounded-lg backdrop-blur-md">
      ...
      <div className="bg-gray-800/40 backdrop-blur-md rounded-lg shadow-lg border border-gray-700/50 overflow-hidden">
        {/* Card Header */}
        <div className="bg-gray-900/60 px-6 py-4 border-b border-gray-700/50">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-100">Business Report</h2>
              <p className="text-gray-400 text-sm">Comprehensive business analytics and insights</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="mb-6">
            <h3 className="text-lg font-medium text-gray-100 mb-2">Report Details</h3>
          ...
          {!reportAvailable ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-100 mb-2">Service Unavailable</h3>
              <p className="text-gray-300 mb-4">The report generation service is currently unavailable.</p>
              <button
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="flex-1 inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {downloading ? (
                  <>
                    <svg className="w-5 h-5 animate-spin mr-2" fill="none" viewBox="0 0 24 24">
          ...
          {/* Report Info */}
          <div className="mt-6 p-4 bg-gray-700/30 rounded-lg border border-gray-600/40">
            <div className="flex items-start">
              <svg className="w-5 h-5 text-blue-400 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div className="text-sm text-gray-300">
                <p className="font-medium text-gray-100 mb-1">Report Information</p>
      ...
      {showPreview && previewUrl && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-xl shadow-2xl max-w-6xl w-full max-h-[95vh] flex flex-col border border-gray-700">
            {/* Modal Header */}
            <div className="flex justify-between items-center p-4 border-b border-gray-700">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-100">Business Report Preview</h3>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-gray-300 p-2 rounded-full hover:bg-gray-700 transition-all duration-200"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1 overflow-auto p-4 bg-gray-900">
              <div className="w-full h-full">
                <iframe 
                  src={previewUrl}
                  className="w-full h-[75vh] border border-gray-700 rounded-lg bg-white"
